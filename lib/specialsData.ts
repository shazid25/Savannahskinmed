...
export const specialCards: SpecialCard[] = [
  ...
  {
    id: 'statesboro-student-1',
    variant: 'story',
    image: '/images/grid-5-img.jpg',
    imageAlt: 'Dermaplaning treatment for the student discount special',
    title: 'Statesboro Student Discounts',
    headline: 'Get Any Customized Medical Facial For $200',
    description: '*Regular Price $250.',
    cta: 'Claim',
    locations: ['statesboro'],
  },
  {
    id: 'statesboro-student-2',
    variant: 'story',
    image: '/images/grid-5-img.jpg',
    imageAlt: 'Dermaplaning treatment for the student discount special',
    title: 'Statesboro Student Discounts',
    headline: 'Get A FREE Dermaplane With Any DiamondGlow® Facial!',
    description:
      'Peach fuzz? Never met her. Sweep away the vellus hairs & dead skin for a clean slate before your treatment. Complementary with student ID.',
    cta: 'Claim',
    locations: ['statesboro'],
  },
  {
    ...
    image: '/images/grid-5-img.jpg',
    imageAlt: 'Dermaplaning treatment for the student discount special',
    title: 'Pooler Student Discounts',
    headline: 'Get A FREE Dermaplane With Any DiamondGlow® Facial!',
    description:
      'Peach fuzz? Never met her. Sweep away the vellus hairs & dead skin for a clean slate before your treatment. Complementary with student ID.',
    cta: 'Claim',
